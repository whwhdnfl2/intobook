...
const HistoryLogEdit = () => {
  ...
  const saveStart = originStartTime === saveStartTime ? selectedLog.startTime : `${saveDate}T${saveStartTime}:00`;
  const saveEnd = originEndTime === saveEndTime ? selectedLog.endTime : `${saveDate}T${saveEndTime}:00`;
