...
![로그인_화면](/uploads/20787494009b4dc2be9257476ddfddec/로그인_화면.png)

로그인 화면

![로그아웃_화면](/uploads/2c2217216cc822a46b17c85c05a08f2f/로그아웃_화면.png)
...
![닉네임_수정_화면](/uploads/d92bbe068d07173a6ae92c99c3a49e5e/닉네임_수정_화면.png)

닉네임 수정 화면

- 닉네임을 수정 할 수 있습니다.

![닉네임_수정_완료_화면](/uploads/38ec295c35bc8c11da7ffa01bbe23332/닉네임_수정_완료_화면.png)

닉네임 수정 완료 화면

- 변경한 이름인 북!빠지다 확인 가능

![닉네임_변경_실행화면](/uploads/d6f015bd91c203cadb22dd0f11026e2e/닉네임_변경_실행화면.gif)

닉네임 변경 실행화면

## 3. 메인 페이지 및 책갈피 튜토리얼

![메인_화면](/uploads/578ece218417aa08a6f444130d6135ba/메인_화면.png)
메인 화면

- 위에서 부터 책갈피 ON/OFF 상태표시(고래 아이콘), 블루투스 연결/미연결 표시, 등록된 책 표시 를 나타냅니다.

![책갈피_튜토리얼_실행화면](/uploads/4ece9620ff3e51fbceec13be3f97f62f/책갈피_튜토리얼_실행화면.gif)
...
![책갈피_미연결_화면](/uploads/324145e6df99992c4ae35d5310ee52c3/책갈피_미연결_화면.png)

책갈피 미연결 화면

- 블루투스 미연결 상태

![페어링_과정_실행_화면](/uploads/278659fb38e8b9d7113f275591594ebe/페어링_과정_실행_화면.gif)
...
![책을_읽고_있지_않을_때_화면](/uploads/f4e2d1080b1c405b1563f1e415fef87c/책을_읽고_있지_않을_때_화면.png)

책을 읽고 있지 않을 때 화면

- 연결 이후, 책갈피가 책에 들어가 있을 때(책을 읽고 있지 않을 때) 모습입니다.

![책을_읽고_있을_때_화면](/uploads/0fba45a403c8d093a6a7145d82f4ceb4/책을_읽고_있을_때_화면.png)

책을 읽고 있을 때 화면

- 연결 이후, 책갈피가 책에서 빠져 있을 때(책을 읽을 때) 모습입니다.

![책갈피_이용한_책_기록_실행_화면](/uploads/9dbbac1b1c10ad3fe153f84ea83a9f6f/책갈피_이용한_책_기록_실행_화면.gif)
...
![책_검색_화면](/uploads/fbeb6dd8969e5ea740922c3ec82f0bd0/책_검색_화면.png)
책 검색 화면

![책_검색하여_등록_화면](/uploads/4e2d76fa9fa5583004dd65c06b56215e/책_검색하여_등록_화면.png)

책 검색하여 등록 화면

![책_검색_실행화면](/uploads/19320d360ad483a044a37047154682f0/책_검색_실행화면.gif)

책 검색 실행화면

## 9. 책 등록 - 바코드 촬영으로 등록

![바코드_촬영_화면](/uploads/21764e1ae3699e0b81304d2685600c96/바코드_촬영_화면.png)

바코드 촬영 화면

![바코드로_인식된_책_등록_화면](/uploads/cc11af73b0bdc5d33af5ea91c09a6eb7/바코드로_인식된_책_등록_화면.png)
바코드로 인식된 책 등록 화면

## 10. 책 등록 - 기존 책장에서 등록

![책장에서_등록_화면](/uploads/2b79643cb89e038454068738a5464798/책장에서_등록_화면.png)

책장에서 등록

- 내가 읽다가 중단한 책들을 다시 등록할 수 있습니다.

## 11. 나의 책장 : 책 상태 분류/정렬 기능

![책_상태에_따른_분류_화면](/uploads/8c2c91b6cd041120a5c7a330d5d50b4e/책_상태에_따른_분류_화면.gif)
...
![여러_기준에_따른_책_정렬_화면](/uploads/f6dddf2b60363a71772d735ae35a32f5/여러_기준에_따른_책_정렬_화면.gif)

여러 기준에 따른 책 정렬 화면

- 책은 여러 기준으로 정렬할 수 있습니다. 등록순, 저자순, 제목순, 진행률 순으로 정렬 가능합니다.

![읽는_중인_책_상세_화면](/uploads/32c1abaa47f7d5dc7fcbda3c8f8552ce/읽는_중인_책_상세_화면.png)

읽는 중인 책 상세 화면

![읽기_중단인_책_상세_화면](/uploads/84e073242804bd9f52e19a90d6ef0b14/읽기_중단인_책_상세_화면.png)


읽기 중단인 책 상세 화면

![읽는_완료인_책_상세_화면](/uploads/9be86ab2f870e54c3bd46281757cab7e/읽는_완료인_책_상세_화면.png)

읽는 완료인 책 상세 화면

- 각각의 책의 상태는 총 3가지로,  현재 읽고 있는 책(파랑), 읽다 멈춘 책(노랑), 다 읽은 책( 빨강)입니다.

## 13. 책 상세 화면 : 책기록 조회 수정 및 삭제

![책_기록_화면](/uploads/4024338680928a4870deddd05cfc4943/책_기록_화면.png)

책 기록 화면

- 책갈피를 이용해서 자동으로 쌓인 책 기록들이 쌓여 있는 모습을 볼 수 있고, 내가 등록한 한줄평을 살펴보고, 수정할 수 있습니다.

![책_기록_수정_및_삭제_화면](/uploads/1c596d05a1f0c063faf6e35b354af38d/책_기록_수정_및_삭제_화면.png)

책 기록 수정 및 삭제 화면

- 각각의 기록 우측 상단에 수정하기를 누르면 한줄평을 수정할 수 있습니다.

![책_기록_수정_실행_화면](/uploads/76ee2256235a1844c743731348cae617/책_기록_수정_실행_화면.gif)

책 기록 수정 실행 화면

## 14. 독서 통계

![독서_통계_캐릭터_화면](/uploads/c32bf3713f3cdaf5c3835b761b76c486/독서_통계_캐릭터_화면.png)

독서 통계 캐릭터 화면

- 나만의 독서 통계를 확인할 수 있습니다. 캐릭터 유형은 총 8가지 유형입니다. 통계에서는 독서와 관련된 여러 통계를 확인할 수 있습니다.

![독서_통계_기록_화면](/uploads/e69cd5a08e136fe8a5aecd40f581ebd4/독서_통계_기록_화면.png)

독서 통계 기록 화면

- 스크롤을 내리면 지난주와 비교해서 얼만큼 많이 읽었는지 그래프를 통해서도 확인 가능합니다.

![독서_통계_실행화면](/uploads/89e1fa8a1d538da8ff6ac5d427797f04/독서_통계_실행화면.gif)
...
![요구사항_정의서](/uploads/77617fbad7924cc65432d94952221a6d/요구사항_정의서.png)

- 디자인 시안(Figma)

![디자인_시안_Figma_](/uploads/e49c61634e38375e49bd9211e301a097/디자인_시안_Figma_.png)

- ERD
    
![ERD](/uploads/ff8213976039f428b2efce9fa56c0920/ERD.png)
    

- 아키텍쳐

![아키텍쳐](/uploads/7d95363064418dc04d68bddb5dc165d6/아키텍쳐.png)
...
![책갈피_회로도](/uploads/3bec73fb414684f87976a9a59424a666/책갈피_회로도.png)

책갈피 회로도

![책_갈피_내부_구조](/uploads/34f46eb5e7b7aba2ccac182915be51a8/책_갈피_내부_구조.png)!

책 갈피 내부 구조

[책갈피_완성품](/uploads/20b469ad9fb09e5a7c60504e172f6bff/책갈피_완성품.png)
...
![그라운드룰](/uploads/ddc3c449f0a85b2e95a086826fd97570/그라운드룰.png)

- 노션 기반 진행상황 공유

![노션_기반_진행상황_공유](/uploads/ab73ef9adb999f4ec4ab5544f62dde3b/노션_기반_진행상황_공유.png)

- 데일리 스크럼 및 주간 회고

![데일리_스크럼_및_주간_회고](/uploads/327de9de36506a814fc5512919598c45/데일리_스크럼_및_주간_회고.png)

- Gitflow 전략 및 통일된 커밋 메시지

![Gitflow_전략_및_통일된_커밋_메시지](/uploads/731ba8033fd6883cd4bae99933fcb360/Gitflow_전략_및_통일된_커밋_메시지.png)

- 지라를 사용한 일정 관리

![지라를_사용한_일정_관리](/uploads/b3a0022c54c5c3f21c874c7343b4ee83/지라를_사용한_일정_관리.png)

- 깃랩을 통한 코드 형상 관리

![깃랩을_통한_코드_형상_관리](/uploads/03e8f5fd428d5d55cbd25d47a6e44aa5/깃랩을_통한_코드_형상_관리.png)
